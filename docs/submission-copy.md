...
- 名称：小南梁（dsh-desktop-app）
- 一句话：把 DeepSeek Harness 封装成 Tauri 2 桌面应用的技能包与源码（macOS + Windows 双平台）
- 仓库：https://github.com/<你的账号>/dsh-desktop-app

## 简介（中文）

「小南梁」是 DeepSeek Harness（DSH）的桌面壳：Tauri 2 实现，11MB 体积，
...
XiaoNanLiang (dsh-desktop-app) wraps the DeepSeek Harness web GUI in a Tauri 2
